...
![ACID foundations overview](/blog/acid-pillars.svg)

_Figure: ACID as four complementary guarantees for reliable transaction processing._
...
![Write-Ahead Logging flow](/blog/wal-flow.svg)

_Figure: WAL ordering ensures changes are recoverable before data files are updated._
...
![Lakehouse commit flow](/blog/lakehouse-commit-flow.svg)

_Figure: Optimistic concurrency in lakehouses uses atomic metadata commits and retries on conflicts._
